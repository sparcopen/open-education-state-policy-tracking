...
<tr><td>Companion</td><td>For bills, the number of a companion bill in the opposite chamber, if any. All companion bills are tracked separately as their own entry.</td></tr>
<tr><td>URL</td><td>The link to more information about the policy. Corrections welcome.</td></tr>
<tr><td>Status</td><td>This field was used to keep track of the policy's status over time. In some cases it is a complete history, in others it is only the last known status. There are some common terms, but nothing is standardized. We have made an effort to at least ensure the final status is marked, but we would caution that some of the information may be incomplete.</td></tr>
...
<tr><td>Author/Sponsor</td><td>The author or sponsor of the policy. For bills, the legislator(s) are listed. For other policies, the body enacting the policy is listed.</td></tr>
...
<tr><td>Enacted</td><td>Whether or not the policy was ultimately enacted, to the best of our knowledge. Answers are Yes or No, and blank means it has not been determined yet.</td></tr></table>
